<template>
  <div id="registerStudent">
    ...
    <v-container>
      <v-card width="fit-content" class="mx-auto mt-10 mb-12">
        <v-card-title class="headline primary white--text pa-2" primary-title>Register Student</v-card-title>
        ...
        this.$http
          ...
          .then(res => {
            ...
            this.reset();
             ...
             window.open(
              "https://student.gardez-votre-permis.fr/login",
              "_blank"
            );
          })
          .catch(e => {
